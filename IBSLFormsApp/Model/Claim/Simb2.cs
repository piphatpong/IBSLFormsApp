...
{
    internal class Simb2
    {
        public static string simb2s(List<string> sensitiveFieldList, object jsonContent, string pubKeyCert)
        {
            ...
            foreach (var item in jsonarry)
            {
                ...
                SIMB2 pocInsureds = JsonConvert.DeserializeObject<SIMB2>(insuresdJson);
