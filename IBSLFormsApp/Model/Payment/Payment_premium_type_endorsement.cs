...
using static IBSLFormsApp.Model.MapDataPayment.Payment_Premium_Type_Endorsement_Mapdata;
using System.Text.Json.Nodes;
using IBSLFormsApp.Model.MapDataPayment;

namespace IBSLFormsApp.Model.Payment
{
    internal class Payment_premium_type_endorsement
    {
        public static string payment_premium_type_endorsement(List<string> sensitiveFieldList, object jsonContent, String pubKeyCert)
        {
            ...
            foreach (var item in jsonarry)
            {
                ...
                Payment_Premium_Type_Endorsement_Mapdata pocInsureds = JsonConvert.DeserializeObject<Payment_Premium_Type_Endorsement_Mapdata>(insuresdJson);
