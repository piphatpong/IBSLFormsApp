...
namespace IBSLFormsApp.Model.MapDataPolicy
{
    public class PocModel
    {
        ...
        public string pol_type_gli_plan { get; set; }
        ...
        public string pol_payment_amount { get; set; }
        ...
        public string pol_year { get; set; }
        public string pol_status { get; set; }
        public string pol_status_note { get; set; }
        public string pol_status_date { get; set; }
        public string pol_expropriation_value { get; set; }
        public string pol_immediate_refund { get; set; }
