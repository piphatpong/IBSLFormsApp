...
{
    internal class IbslUatPolicyApi
    {
        public async Task<string> ibsluatpolicyapi(string token, string url, JObject content)
        {
            /*************** Log Test ***************/
            DebugLog debl = new DebugLog();
            string logTest = "ibsl-policy-api: " + url;
