...
{
    internal class CoverageProgram
    {
        public static string coverageProgram(List<string> sensitiveFieldList, List<string> listUrl, object jsonContent, string pubKeyCentralPath)
        {
           ...
           // string privKeycompPath = "company.key";
            ...
            foreach (var item in jsonarry)
            {
                ...
                Coverages pocInsureds = JsonConvert.DeserializeObject<Coverages>(insuresdJson);
